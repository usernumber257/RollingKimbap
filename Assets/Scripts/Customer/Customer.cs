...
public class SitState : State
{
    ...
    void MoveToSeat()
    {
        ...
        customer.transform.position = Vector2.MoveTowards(customer.transform.position, target.position, Time.deltaTime * customer.Speed);
...
public class ExitState : State
{
    ...
    void MoveToExit()
    {
        customer.transform.position = Vector2.MoveTowards(customer.transform.position, customer.mySeat.navPivot[moveIndex].position, Time.deltaTime * customer.Speed);
